                        ...
                        <div class="body">
                            <ul>
                                <li>
                                    ...
                                    <a class="figure" href="#pic1" data-toggle = "modal"><img class = "image-rounded"src="pics/HANDBAG/palak paneer.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a class="figure" href="#pic2" data-toggle = "modal" ><img class = "image-rounded"src="pics/SCHOOL/spring rolls.jpg" alt=""></a>

                                </li>
                                <li>
                                    <a class="figure" href="#pic3" data-toggle = "modal" ><img class = "image-rounded" src="pics/TRAVEL/vegetable pulao.jpg" alt=""></a>

                                </li>
                                <li>
                                    <a class="figure"  href="#pic4" data-toggle = "modal" ><img class="img-rounded" src="pics/TRAVEL/lassi.jpg" alt=""></a>
                                </li>
